...
IMG_HOVER_EFFECT.src = "../IMG/HoverEffectUpgraideCenter.png";


$(() => {
    $(".container-img-upgraide-center img").mouseover(() => {
        IMG_NOT_HOVER_EFFECT.src = "../IMG/HoverEffectUpgraideCenter.png";
    })

    $(".container-img-upgraide-center img").mouseout(() => {
        IMG_NOT_HOVER_EFFECT.src = "../IMG/UpgraideCenterImg.png";
     });
  });